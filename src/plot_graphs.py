...
if __name__ == "__main__":
    ...
    pyplot.plot(nF0new, F0_i,'-r', nF1new, F1_i,'-b', nF2new, F2_i,'-k', nF3new, F3_i, nF4new, F4_i, nF5new, F5_i, nF6new, F6_i, lw= 1.5)
    pyplot.plot(nF0 , F0, 'ro', nF1, F1, 'bo', nF2, F2, 'ko', nF3, F3, nF4, F4, nF5, F5, nF6, F6)
